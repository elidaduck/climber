...
public class Climber extends SubsystemBase {
   ...
   */
   ...
   CANSparkMax winchVictor1;
   CANSparkMax winchVictor2;
  ...
  public Climber() {
    winchVictor1 = new CANSparkMax(0,MotorType.kBrushless);
    winchVictor2 = new CANSparkMax(0,MotorType.kBrushless);

    elevatorSpark = new CANSparkMax(0,MotorType.kBrushless);
  ...
  public void WinchTeleOp() {
    winchVictor1.set( WINCH_POWER);
    winchVictor2.set( -WINCH_POWER);
  }
